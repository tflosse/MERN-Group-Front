...
function Dashboard(props) {
  ...
  const text =
    props.username != ""
      ? `What Brilliant Ideas did the world have while you were gone, ${props.username}?`
      : "What Brilliant Ideas did the world have while you were gone?";
  return (
    <>
      <div className="FeedUltimateContainer">
        ...
        <div className="MainFeed">{ideaArray}</div>
      </div>
    </>
  );
}
